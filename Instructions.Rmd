...
```{R eval=F}
library(tidyverse)
drinks <- read_csv("data/alcohol-consumption/drinks.csv")
cousin_marriage_data <- read_csv("data/cousin-marriage/cousin-marriage-data.csv")
```
...
*projectdata1 <- drinks %>% left_join(marriage, by = c("country"="Country"))*
*The 'drinks' dataset had 193 rows. The 'cousin_marriage_data' dataset had 70 rows.*
...
git remote add origin https://github.com/KENZCAS/project1.git
